...
+ (NSDictionary *)propertiesForClass:(Class)cls
{
    ...
    for (i = 0; i < outCount; i++) {
        ...
        if(propName) {
            ...
            if (![propertyType isEqualToString:@"NSDate"] && ![propertyType isEqualToString:@"UIView"])
            {
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict exclude:(NSArray *)excludeArray {
    ...
    Class cls = [obj class];
    NSDictionary* properties = [ObjMapper propertiesForClass:cls];
    ...
    for (id key in dict) {
        ...
        if ([propertyType isEqualToString:@"NSString"] \
            ...
            if ([propertyType isEqualToString:@"NSString"] == NO &&
                ...
                [ObjMapper populateObject:childObj fromDictionary:value exclude:nil];
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict {
    obj = [ObjMapper populateObject:obj fromDictionary:dict exclude:nil];
...
+ (id)objectWithClass:(Class)cls fromDictionary:(NSDictionary *)dict {
    ...
    [ObjMapper populateObject:obj fromDictionary:dict];
...
+ (NSMutableDictionary *)mutableDictionaryForObject:(id)obj {
    NSDictionary* propertyDict = [ObjMapper propertiesForClass:[obj class]];
...
+(NSMutableDictionary *)mutableDictionaryForObject:(id)obj include:(NSArray *)includeArray {
    NSDictionary* dict = [ObjMapper dictionaryForObject:obj include:includeArray];
    return [NSMutableDictionary dictionaryWithDictionary:dict];
}

+(NSDictionary*)dictionaryForObject:(id)obj {
    NSMutableDictionary *mutableDict = [ObjMapper mutableDictionaryForObject:obj];
...
+(NSArray *)arrayOfClass:(Class)cls fromArrayOfDictionary:(NSArray *)array {
    NSMutableArray *mutableArray = [ObjMapper mutableArrayOfClass:cls fromArrayOfDictionary:array];
...
+(NSMutableArray *)mutableArrayOfClass:(Class)cls fromArrayOfDictionary:(NSArray *)array {
    ...
    for (id item in array) {
        ...
        if ([item isKindOfClass:[NSDictionary class]] == NO) {
            TRC_NRM(@"TDUtils: item inside array must be NSDictionary object");
            continue;
        }
        
        // Convert item dictionary to object with predefined class
        id obj = [ObjMapper objectWithClass:cls fromDictionary:item];
